    ...
    if (($amount)<0)
   {
    ...
    //For 0 (zero) value
         ...
         echo "</script>";
                ...
                if($query){
                     echo "<script> alert('Congratulation Your Transaction Successfully Done !');
...
<body style="background-color:thistle">
    ...
    <nav class="navbar py-2 navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">VISUAL BANK <img src="logos/logo.webp" alt="Bank" width="50" height="50"></a>
 ...
 <!-- Table -->
 <div class="container">
        <h2 class="text-center pt-4" style="color : black;">Here is Details of Sender</h2>
            <?php
                include 'connect.php';
                $sid=$_GET['id'];
